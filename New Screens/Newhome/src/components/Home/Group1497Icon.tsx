...
const Group1497Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 29 29' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path
      ...
      fill='#D9D9D9'
    />
    <g opacity={0.56} filter='url(#filter0_d_74_1226)'>
      <path
    ...
    <defs>
      ...
      >
        ...
        <feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_74_1226' />
        <feBlend mode='normal' in='SourceGraphic' in2='effect1_dropShadow_74_1226' result='shape' />
      </filter>
    </defs>
  </svg>
);
